...
# If the file doesn't exist
   ...
   console.print("Dataset file could not be found. Make sure it exists in the directory", style="bold white on red")
# If the file has failed to be read, e.g. incorrect filesystem permissions, another program is using it etc.
except IOError as e:
   log.error("[bold red]Fatal error while reading dataset file[/]", extra={ "markup": True })
   ...
   console.print("1. Does it contain data? It may have failed to download correctly.", style="bold yellow")
   console.print("2. Is it being used by another program?", style="bold yellow")
   console.print("3. Does this program have the correct filesystem permissions to access it?", style="bold yellow")
# Catch any other unhandled exception
except Exception as e:
   log.error("[bold red]Fatal error due to unhandled exception[/]", extra={ "markup": True })
